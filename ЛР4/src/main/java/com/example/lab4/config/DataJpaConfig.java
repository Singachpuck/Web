...
@EnableJpaRepositories(basePackages = {"com.example.lab4.dao"})
@ComponentScan(basePackages = {"com.example.lab4"})
public class DataJpaConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("com.example.lab4.model");
